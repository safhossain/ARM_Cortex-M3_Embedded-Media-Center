 ...
 * 
 * Modified: Safwan Hossain for COE718-F2024 Embedded Systems Final Project 
 *---------------------------------------------------------------------------*/
...
int music_time (void)
{
  ...
  LPC_TIM0->TCR = 1;									/* TC0 Enable */
	...
	GLCD_Clear(Black);
	displayTypeOfText(0, NAV_BAR, "Audio Player");
	displayTypeOfText(9, NAV_BAR, "SEL to Exit");
	GLCD_Bitmap (70, 25, 180, 180, (unsigned char *)GIMP_BEETHOVEN_pixel_data);
